...
void PWM_TIM_Init(void)
{
	...
	TIM_TimeBaseInitStructure.TIM_Period = 999;  //一个pwm的宽度为 0.00002*1000 =0.02=20ms
	TIM_TimeBaseInitStructure.TIM_Prescaler = 1679;// 当AHB1的分频系数不为1时  通用定时器时钟是AHB1总线时钟的2倍 AHB1=42M  则定时器为84M 设置预分频系数为840
