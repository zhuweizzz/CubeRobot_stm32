...
void PWM3_GPIO_Init()
{
	...
	PWM3_GPIO_CLK_Cmd(PWM3_GPIO_CLK, ENABLE);
	
	GPIO_PinAFConfig(PWM3_GPIO, PWM3_GPIOSource, PWM3_GPIO_AF);
...
void PWM3_TIM_Init()
{
	...
	PWM3_TIM_CLK_Cmd(PWM3_TIM_CLK, ENABLE);
	...
	TIM_TimeBaseInit(PWM3_TIM, &TIM_TimeBaseInitStructure);
	...
	TIM_OC3PreloadConfig(PWM3_TIM,TIM_OCPreload_Enable);
...
{
	TIM_SetCompare3(PWM3_TIM, scale);
}
